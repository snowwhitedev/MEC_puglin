jQuery(document).ready(function($) {
  ...
  $("#mec_add_not_in_days").on("click", function() {
    ...
    var html = $("#mec_new_not_in_days_raw")
      .html()
      .replace(/:i:/g, key)
      .replace(/:val:/g, date);
  ...
  $("#mec_add_hourly_schedule_day_button").on("click", function() {
    ...
    var html = $("#mec_new_hourly_schedule_day_raw")
      .html()
      .replace(/:d:/g, key)
      .replace(/:dd:/g, parseInt(key) + 1);
  ...
  $("#mec_add_ticket_variation_button").on("click", function() {
    ...
    var html = $("#mec_new_ticket_variation_raw")
      .html()
      .replace(/:i:/g, key);
  ...
  $(".mec-form-row.mec-available-color-row span").on("click", function() {
    $(".mec-form-row.mec-available-color-row span").removeClass(
      "color-selected"
    );
  ...
  $("#mec_reg_form_field_types button").on("click", function() {
    ...
    if (type == "mec_email") {
      if (
        $("#mec_reg_form_fields").find(
          'input[value="mec_email"][type="hidden"]'
        ).length
      ) {
        return false;
      }
    ...
    if (type == "name") {
      if (
        $("#mec_reg_form_fields").find('input[value="name"][type="hidden"]')
          .length
      ) {
        return false;
      }
...
function mec_location_toggle() {
  if (jQuery("#mec_location_id").val() != "0")
    jQuery("#mec_location_new_container").hide();
  else jQuery("#mec_location_new_container").show();
}

function mec_organizer_toggle() {
  if (jQuery("#mec_organizer_id").val() != "0")
    jQuery("#mec_organizer_new_container").hide();
  else jQuery("#mec_organizer_new_container").show();
}

function mec_repeat_toggle() {
  if (jQuery("#mec_repeat").is(":checked"))
    jQuery(".mec-form-repeating-event-row").show();
...
function mec_hourly_schedule_listeners() {
  jQuery(".mec-add-hourly-schedule-button")
    .off("click")
    .on("click", function() {
      var day = jQuery(this).data("day");
      var key = jQuery("#mec_new_hourly_schedule_key" + day).val();
      var html = jQuery("#mec_new_hourly_schedule_raw" + day)
        .html()
        .replace(/:i:/g, key)
        .replace(/:d:/g, day);
...
function mec_reg_fields_option_listeners() {
  jQuery("button.mec-reg-field-add-option").on("click", function() {
    ...
    var html = jQuery("#mec_reg_field_option")
      .html()
      .replace(/:i:/g, key)
      .replace(/:fi:/g, field_id);
...
function mec_handle_add_price_date_button(e) {
  ...
  var html = jQuery("#mec_new_ticket_price_raw_" + key)
    .html()
    .replace(/:i:/g, key)
    .replace(/:j:/g, p);
