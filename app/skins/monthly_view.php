...
class MEC_skin_monthly_view extends MEC_skins
{
    ...
    public function initialize($atts)
    {
        $this->atts = $atts;
        //Set Shabbat
        $this->shabbat = ($atts['shabbat']) ? true : false;
        ...
        //for shabbat
        if ($this->shabbat) $this->style = "novel";
        // Next/Previous Month
    ...
    public function search()
    {
        ...
        foreach ($dates as $date => $IDs) {
            ...
            if ($query->have_posts()) {
                ...
                while ($query->have_posts()) {
                    ...
                    $terms = get_object_term_cache($data->ID, "mec_label");
                    $terms = apply_filters('get_the_terms', $terms, $data->ID, "mec_label");
                    if(isset($terms[0]->name) && $terms[0]->name == SHABBAT){
                         $shabbat_events[] = $data;
                    }
                }
            }
        ...
        $this->shabbat_events = $shabbat_events;
        return $events;
    }
