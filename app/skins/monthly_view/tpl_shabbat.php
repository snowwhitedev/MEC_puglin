...
<div id="mec_skin_<?php echo $this->id; ?>" class="mec-wrap <?php echo $event_colorskin . ' ' . $this->html_class; ?>">
        ...
        <div class="mec-calendar-side mec-clear">
            ...
            <?php else : ?>
                <div class="mec-calendar-header">
                    <h2><?php echo date_i18n('Y F', $current_month_time); ?></h2>
                </div>
            <?php endif; ?>

            <div class="mec-calendar-table" id="mec_skin_events_<?php echo $this->id; ?>">
                <div class="mec-month-container mec-month-container-selected" id="mec_monthly_view_month_<?php echo $this->id; ?>_<?php echo date('Ym', $current_month_time); ?>" data-month-id="<?php echo date('Ym', $current_month_time); ?>">
                    <?php echo $month_html; ?>
    ...
    <article class="row mec-single-event mec-single-modern">
        <div class="mec-events-meta-group mec-events-meta-group-booking">
            <?php echo $this->main->module('booking.default_shabbat', array('event' => $this->shabbat_events));?>
        </div>
    </article>
</div>