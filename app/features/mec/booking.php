                                    ...
                                    <div class="mec-col-4">
                                        ...
                                        <span class="mec-tooltip">
                                            <div class="box">
                                                ...
                                                <div class="content"><p><?php esc_attr_e("You can show booking form only at certain time before event start. If you set this option to 30 then booking form will open only 30 minutes before starting the event!", 'mec'); ?></p></div>
                                            </div>
                                            <i title="" class="dashicons-before dashicons-editor-help"></i>
                                        </span>
                                    </div>
