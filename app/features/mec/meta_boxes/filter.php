    ...
    <div class="mec-meta-box-fields" id="mec_meta_box_calendar_filter">
        <div class="mec-create-shortcode-tabs-wrap">
            <div class="mec-create-shortcode-tabs-left">
                <a class="mec-create-shortcode-tabs-link mec-tab-active" data-href="mec_select_categories" href="#"><?php echo esc_html('Categories' ,'mec'); ?></a>
                <a class="mec-create-shortcode-tabs-link" data-href="mec_select_locations" href="#"><?php echo esc_html('Locations' ,'mec'); ?></a>
                <a class="mec-create-shortcode-tabs-link" data-href="mec_select_organizers" href="#"><?php echo esc_html('Organizers' ,'mec'); ?></a>
                <a class="mec-create-shortcode-tabs-link" data-href="mec_select_labels" href="#"><?php echo esc_html('Labels' ,'mec'); ?></a>
                <a class="mec-create-shortcode-tabs-link" data-href="mec_select_tags" href="#"><?php echo esc_html('Tags' ,'mec'); ?></a>
                <a class="mec-create-shortcode-tabs-link" data-href="mec_select_authors" href="#"><?php echo esc_html('Authors' ,'mec'); ?></a>
                <a class="mec-create-shortcode-tabs-link" data-href="mec_select_dates" href="#"><?php echo esc_html('Dates' ,'mec'); ?></a>
            </div>
                ...
                <div class="mec-form-row mec-create-shortcode-tab-content" id="mec_select_dates">
                    ...
                    <div id="mec_date_only_past_filter">
                        <div class="mec-form-row mec-switcher">
                            ...
                            <p class="description" style="color: red;"><?php echo sprintf(__('It shows %s expired/past events. It will use selected start date as first day and then go to %s dates.', 'mec'), '<strong>'.__('only', 'mec').'</strong>', '<strong>'.__('older', 'mec').'</strong>'); ?></p>
                        </div>
                        <br />
                    </div>
